...
Public Class YAMLramAssemblyLineTypes
    ...
    Public Sub ImportFile(ByVal Params As ImportParameters)
        ...
        Table.Add(New DBTableField("baseTimeMultiplier", FieldType.float_type, 0, True))
        Table.Add(New DBTableField("baseMaterialMultiplier", FieldType.float_type, 0, True))
        Table.Add(New DBTableField("baseCostMultiplier", FieldType.float_type, 0, True))
        ...
        Table.Add(New DBTableField("minCostPerHour", FieldType.float_type, 0, True))
        ...
        For Each DataField In YAMLRecords
            ...
            DataFields.Add(UpdateDB.BuildDatabaseField("baseTimeMultiplier", DataField.baseTimeMultiplier, FieldType.float_type))
            DataFields.Add(UpdateDB.BuildDatabaseField("baseMaterialMultiplier", DataField.baseMaterialMultiplier, FieldType.float_type))
            DataFields.Add(UpdateDB.BuildDatabaseField("baseCostMultiplier", DataField.baseCostMultiplier, FieldType.float_type))
            DataFields.Add(UpdateDB.BuildDatabaseField("volume", DataField.volume, FieldType.float_type))
            DataFields.Add(UpdateDB.BuildDatabaseField("activityID", DataField.activityID, FieldType.tinyint_type))
            DataFields.Add(UpdateDB.BuildDatabaseField("minCostPerHour", DataField.minCostPerHour, FieldType.float_type))
