...
Public Class YAMLcontrolTowerResources
    ...
    Public Sub ImportFile(ByVal Params As ImportParameters)
        ...
        Table.Add(New DBTableField("minSecurityLevel", FieldType.double_type, 0, True))
            ...
            With DataField.Value
                If .resources.Count > 0 Then
                    For Each resource In DataField.Value.resources
                        ...
                        DataFields.Add(UpdateDB.BuildDatabaseField("minSecurityLevel", resource.minSecurityLevel, FieldType.double_type))
