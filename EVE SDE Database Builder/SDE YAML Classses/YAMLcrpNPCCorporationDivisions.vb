...
Public Class YAMLcrpNPCCorporationDivisions
    ...
    Public Const crpNPCCorporationDivisionsFile As String = "crpNPCCorporationDivisions.yaml"
    ...
    Public Sub ImportFile(ByVal Params As ImportParameters)
        ...
        Dim YAMLRecords As New List(Of crpNPCCorporationDivision)
        ...
        Table.Add(New DBTableField("size", FieldType.tinyint_type, 0, True))
        ...
        Try
            ...
            YAMLRecords = DS.Deserialize(Of List(Of crpNPCCorporationDivision))(New StringReader(File.ReadAllText(YAMLFile)))
        ...
        For Each DataField In YAMLRecords
            ...
            DataFields.Add(UpdateDB.BuildDatabaseField("size", DataField.size, FieldType.tinyint_type))
