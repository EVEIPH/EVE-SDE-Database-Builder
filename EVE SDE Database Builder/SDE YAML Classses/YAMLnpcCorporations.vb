...
Public Class YAMLnpcCorporations
    ...
    Public Sub ImportFile(ByVal Params As ImportParameters)
        ...
        Table.Add(New DBTableField("corporationName", FieldType.nvarchar_type, 100, True))
        Table.Add(New DBTableField("corporationDescription", FieldType.nvarchar_type, 1000, True))
