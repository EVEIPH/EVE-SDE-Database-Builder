...
Public Class YAMLramActivities
    Inherits YAMLFilesBase

    Public Const ramActivitiesFile As String = "ramActivities.yaml"
    ...
    Public Sub ImportFile(ByVal Params As ImportParameters)
        FileNameErrorTracker = ramActivitiesFile
        ...
        Try
            ...
            YAMLRecords = DS.Deserialize(Of List(Of ramActivity))(New StringReader(File.ReadAllText(YAMLFile)))
...
Public Class ramActivity
    ...
    Public Property iconNo As Object
